...
<body>
	...
	<!-- Menu -->
		<g:render template="/common/menu" model="[tag:'campers']"/>
		<!-- End Menu -->	
		...
		<!-- page-content -->
			<div class="page-content">
				...
				<!-- 2 cols -->
					...
					<div class="one-half">
						<h4 class="heading">Camp Schedule</h4>
	        		<p class="infobox-warning">We are working on this</p>
	        		<%--<a class="link-button green" href="#">Click here</a> --%> 
